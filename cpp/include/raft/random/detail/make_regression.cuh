                                  ...
                                  cudaStream_t stream)
{
  ...
  raft::launch_kernel(stream, raft::ceildiv<IdxT>(n, 256), 256)(
    _singular_profile_kernel, singular_vec.data(), n, tail_strength, effective_rank);
                            ...
                            raft::random::GeneratorType type = raft::random::GenPC)
{
  ...
  if (shuffle) {
    ...
    raft::launch_kernel(stream, nblks_rows, Nthreads)(
      _gather2d_kernel<DataT, IdxT>, values, _values, perms_samples.data(), n_rows, n_targets);
    ...
    if (coef != nullptr) {
      ...
      raft::launch_kernel(stream, nblks_cols, Nthreads)(
        _gather2d_kernel<DataT, IdxT>, coef, _coef, perms_features.data(), n_cols, n_targets);
    }
  }
}
